    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <Card hover={false} className="md:col-span-1">
        ...
        <div className="space-y-3">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="p-3 rounded-lg bg-black/30 border border-crimson-600/30">
              Contato #{i + 1}
            </div>
          ))}
        </div>
      ...
      <Card hover={false} className="md:col-span-2">
        ...
        <div className="flex gap-2">
          <input
            className="flex-1 px-4 py-3 rounded-lg bg-luxury-black/30 border border-crimson-600/30"
